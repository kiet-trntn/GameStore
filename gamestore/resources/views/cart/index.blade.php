        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
            ...
            <div class="lg:col-span-4">
                <div class="sticky top-32 glass p-8 rounded-[2.5rem] border-white/10 shadow-2xl relative overflow-hidden">
                    ...
                    <div class="space-y-4">
                        <button id="btn-checkout" class="w-full bg-blue-600 hover:bg-blue-500 text-white font-black text-xs uppercase tracking-[0.2em] py-5 rounded-2xl shadow-lg shadow-blue-500/20 transition-all hover:-translate-y-1">
                            Thanh toán ngay
                        </button>
...
<script>
    console.log("Đã nạp file JS chuẩn! Nếu không thấy dòng này là do chưa Ctrl + F5");

    // ==========================================
    // 1. CHỨC NĂNG XÓA GAME KHỎI GIỎ HÀNG
    // ==========================================
    ...
    if (btnCheckout) {
        btnCheckout.addEventListener('click', function() {
            ...
            Swal.fire({
                title: 'Chốt đơn nha?',
                text: "Tiền trao cháo múc, game sẽ bay thẳng vào tài khoản của ba!",
                icon: 'question',
                showCancelButton: true,
                confirmButtonColor: '#2563EB',
                cancelButtonColor: '#d33',
                confirmButtonText: 'Quẹt thẻ luôn!',
                cancelButtonText: 'Khoan đã'
            }).then((result) => {
                if (result.isConfirmed) {
                    
                    let originalText = btnCheckout.innerHTML;
                    btnCheckout.innerHTML = '<i class="fas fa-spinner fa-spin text-xl"></i> Đang xử lý...';
                    ...
                    .catch(err => {
                        console.error(err);
                        Swal.fire('Lỗi Code Rồi!', 'Mở Console F12 xem ngay!', 'error');
                        btnCheckout.innerHTML = originalText;
                        btnCheckout.disabled = false;
                    });
                }
