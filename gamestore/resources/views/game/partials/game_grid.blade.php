            ...
            <div class="group relative bg-white/[0.02] rounded-[2rem] overflow-hidden border border-white/5 hover:border-blue-500/40 transition-all duration-500 hover:-translate-y-2">
                ...
                <a href="{{ route('game.detail', $game->slug) }}" class="block">
                    <div class="aspect-[3/4] overflow-hidden relative">
                        ...
                        @endphp
                        <img loading="lazy" src="{{ $imageUrl }}" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                ...
                <div class="p-6">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        {{-- Nút giỏ hàng (Đã gắn btn-add-cart và data-id) --}}
                        <button class="btn-add-cart w-12 h-12 glass rounded-2xl flex items-center justify-center hover:bg-blue-600 hover:text-white transition-all" data-id="{{ $game->id }}">
